...
!function (t, n) {
  ...
  var n = "undefined" != typeof window,
    ...
    if (O(t)) {
      ...
      M = function M(t, n) {
    z(t, "sizes", s(t, n.data_sizes)), z(t, "srcset", s(t, n.data_srcset)), z(t, "src", s(t, n.data_src));
  },
      R = function R(t) {
    ...
    VIDEO: function VIDEO(t, n) {
      w(t).forEach(function (t) {
        z(t, "src", s(t, n.data_src));
      }), z(t, "poster", s(t, n.data_poster)), z(t, "src", s(t, n.data_src)), t.load();
    }
  },
      S = function S(t, n, e) {
    var i = G[t.tagName];
    ...
    }(t), D(e), L(t, n.class_loading), k(t, n, e);
  },
      H = function H(t, n, e) {
    var i = I(t) || t;
    ...
    if (!U(i)) {
      !function (t, n, e) {
        U(t) || (t.llEvLisnrs = {}), P(t, "load", n), P(t, "error", e), "VIDEO" === t.tagName && P(t, "loadeddata", n);
      }(i, function (o) {
        !function (t, n, e, i) {
          q(n, e, i), y(n, e.class_loaded), f(n, "loaded"), E(e.callback_loaded, n, i), F(e, i);
        }(0, t, n, e), $(i);
      }, function (o) {
        !function (t, n, e, i) {
          q(n, e, i), y(n, e.class_error), f(n, "error"), E(e.callback_error, n, i), F(e, i);
        }(0, t, n, e), $(i);
      });
    }
  },
    ...
    n && (v(t) && _(t), clearTimeout(n), m(t, null));
      ...
      W = function W(t, n, e, i) {
    "IMG" === t.tagName && ($(t), function (t) {
      T(t, function (t) {
        R(t);
      }), R(t);
    }(t), function (t) {
    ...
    }(t), L(t, e.class_loading), D(i), E(e.callback_cancel, t, n, i), setTimeout(function () {
      i.resetElementStatus(t, i);
    }, 0));
  },
      X = function X(t, n, e, i) {
    E(e.callback_enter, t, n, i), p(t) || (e.load_delay ? function (t, n, e) {
      ...
      Y = function Y(t, n, e, i) {
    g(t) || (e.cancel_on_exit && function (t) {
      return "loading" === d(t);
    }(t) && W(t, n, e, i), E(e.callback_exit, t, n, i), e.load_delay && v(t) && Q(t));
  },
      Z = ["IMG", "IFRAME"],
      tt = function tt(t) {
    ...
    t.forEach(function (t) {
      -1 !== Z.indexOf(t.tagName) && (t.setAttribute("loading", "lazy"), function (t, n, e) {
        H(t, n, e), S(t, n, e), B(e), f(t, "native"), F(n, e);
      }(t, n, e));
    }), e.toLoadCount = 0;
  },
      et = function et(t) {
    ...
    var n,
        e = t._settings;
    (n = ot(e), it(n).filter(at)).forEach(function (t) {
      L(t, e.class_error), _(t);
    }), t.update();
  },
      lt = function lt(t, e) {
    var i;
    this._settings = c(t), this.loadingCount = 0, et(this), i = this, n && window.addEventListener("online", function (t) {
      ct(i);
    }), this.update(e);
  };
  ...
  return lt.prototype = {
    update: function update(t) {
      var n,
          ...
          a = this._settings,
          r = rt(t, a);
      (this.toLoadCount = r.length, !e && i) ? tt(a) ? nt(r, a, this) : (n = this._observer, o = r, function (t) {
        t.disconnect();
      }(n), function (t, n) {
    ...
    resetElementStatus: function resetElementStatus(t) {
      !function (t, n) {
        p(t) && function (t) {
          t && (t.toLoadCount += 1);
        }(n), f(t, null);
